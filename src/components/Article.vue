            ...
            <social-sharing :url="windowLocation"
              ...
              <div class="mt1">
                <network network="googleplus">
                  <i class="fa fa-fw fa-google-plus social-btn"></i>
                </network>
                <network network="facebook">
                  <i class="fa fa-fw fa-facebook social-btn"></i>
                </network>
                <network network="vk">
                  <i class="fa fa-fw fa-vk social-btn" aria-hidden="true"></i>
                </network>
                <network network="twitter">
                  <i class="fa fa-fw fa-twitter social-btn"></i>
                </network>                
                <network network="linkedin">
                  <i class="fa fa-fw fa-linkedin social-btn"></i>
                </network>
              </div>
            </social-sharing>
          </div>
